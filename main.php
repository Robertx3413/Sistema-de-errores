    ...
    <div class="container">
        <header class="header">
            ...
            <nav class="nav">
                ...
                <?php
                if ($rol === 1){
                    // Query to count records in equiposreparados table
                    $countQuery = "SELECT COUNT(*) as total FROM equiposreparados";
                    ...
                    <li class="nav-item">
                        <a href="equiposReparados\dashboard.php">
                            ...
                            <svg class="icon-nav" width="32" height="32" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                            <!-- Monitor body -->
                            <rect x="10" y="14" width="44" height="28" rx="4" fill="black" stroke="black" stroke-width="2"/>
                            <!-- Monitor screen -->
                            <rect x="12" y="16" width="40" height="24" rx="2" fill="white" stroke="black" stroke-width="2"/>
                            <!-- Stand -->
                            <rect x="28" y="44" width="8" height="6" fill="black" stroke="black" stroke-width="2"/>
                            <!-- Base -->
                            <rect x="24" y="50" width="16" height="4" rx="2" fill="black" stroke="black" stroke-width="2"/>
                            <!-- Notification Badge -->
                            </svg>
                            <!-- fin de notificaciones -->
                            <span class="nav-item-text">Equipos reparados</span>
                            <?php if ($totalRecords > 0): ?>
                                <svg width="42" height="42" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                    <!-- Notification Badge -->
                                    <circle cx="16" cy="16" r="10" fill="red"/>
                                    <text x="16" y="21" text-anchor="middle" font-size="16" font-weight="bold" fill="white"><?= $totalRecords ?></text>
                                </svg>
                            <?php endif; ?>
                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    ...
                    <div class="modal">
                        <div class="modal-content">
                            ...
                            <div class="modal-actions">
                                <a href="eliminar.php?eliminarid=<?= $row['id'] ?>" class="btn btn-danger">Eliminar</a>
